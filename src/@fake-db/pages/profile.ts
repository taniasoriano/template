...
const data: DataType = {
  profileHeader: {
    fullName: 'Jorge Cantero',
    location: 'Valencia',
    joiningDate: '01 Marzo 2023',
    designation: 'GestoriaEnCasa.PackAdvance',
  ...
  profile: {
    about: [
      { property: 'Nombre Completo', value: 'Jorge Cantero', icon: 'mdi:account-outline' },
      { property: 'Estado', value: 'Activo', icon: 'mdi:check' },
      { property: 'Rol', value: 'Particular', icon: 'mdi:star-outline' },
      { property: 'País', value: 'España', icon: 'mdi:flag-outline' }
    ],
    contacts: [
      { property: 'Teléfono', value: '632 152 495', icon: 'mdi:phone-outline' },
      { property: 'Email', value: 'jorge.cantero@ejemplo.com', icon: 'mdi:email-outline' }
    ],
    teams: [
